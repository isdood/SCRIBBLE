...
pub extern fn init_safety_bridge() c_int;
pub extern fn check_safety(code: [*c]const u8, code_len: usize, safety_level: c_int, enable_optimizations: bool, check_ownership: bool) c_int;
pub extern fn get_safety_stats() c_int;
...
pub const SAFETY_LEVEL_CALM = @as(c_int, 0);
pub const SAFETY_LEVEL_BALANCED = @as(c_int, 1);
pub const SAFETY_LEVEL_WILD = @as(c_int, 2);
