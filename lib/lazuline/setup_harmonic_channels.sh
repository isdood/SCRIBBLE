cat > setup_harmonic_tests.sh << 'EOF'
#!/bin/bash
...
chmod +x setup_harmonic_tests.sh

echo "[DONE] Created test setup script"
echo "[INFO] Run './setup_harmonic_tests.sh' to set up the tests"
