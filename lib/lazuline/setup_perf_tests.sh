...
echo -e "${BLUE}Setting up Crystal Runtime performance test suite...${NC}"

# Create performance test directory
mkdir -p zig/crystal/src/tests/perf
...
echo "1. Run 'zig build test' to run all tests including performance tests"
